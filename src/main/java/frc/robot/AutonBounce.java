...
public class AutonBounce extends Auton {
    ...
    public AutonBounce(SwerveDrive drive) {
        super(drive);
        autonIndex = 1;
        autonStep1 = new CurvedDrive(drive, 4, new double[][] {{35.0,-90.0,-45.0},{40,-180,-45},{40,0,-45},{10,-45,-45}});
        autonStep2 = new BottleTurn(drive, 90, false);
        autonStep3 = new CurvedDrive(drive, 2, new double[][] {{60.0,-170.0,0.0},{70.0,10.0,-90.0}});
        autonStep4 = new BottleTurn(drive, -180, false);
        autonStep5 = new CurvedDrive(drive, 1, new double[][] {{20.0,-90.0,-180.0}});
